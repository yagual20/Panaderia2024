...
class LoginActivity : AppCompatActivity() {
    ...
    private fun setup(){
        title = "Autenticación"
        botonRegistrar = findViewById(R.id.login)
        ...
        botonGoogle.setOnClickListener {
            ...
            val googleConf: GoogleSignInOptions = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken(getString(R.string.google_app_id)) //ERROR DE DEFAULT_WEB_CLIENT_ID
                .requestEmail()
                .build()
            val googleClient: GoogleSignInClient = GoogleSignIn.getClient(this, googleConf)
            startActivityForResult(googleClient.signInIntent, 1000)
